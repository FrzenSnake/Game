class Grid {
    ...
    constructor(numCols: number, numRows: number, stage: any) {
    ...
    public getNode(x: number, y: number): Nodes {
        var result: Nodes = this.config[y * this._numRows + x].node;
        return result;
    }
}